...
export const AGENT_DETAILS: Record<string, AgentDetail> = {
  ...
  "code-reviewer": {
    ...
    longDescription:
      "Code Reviewer is trained on thousands of audited Solidity contracts and Web3 integration patterns. It reviews your code for common anti-patterns, gas inefficiencies, and security concerns — producing annotated diff reports. It also generates boilerplate for common contract patterns and suggests refactoring opportunities.",
    whatItDoes: [
  ...
  "nft-appraiser": {
    ...
    price: "0.001",
    priceUnit: "5 min",
    priceLabel: "0.001 ETH / 5 min",
    depositMultiplier: 1.5,
    tagline: "Fair value estimates for any NFT, on demand.",
    description: "Estimates NFT value based on rarity, trait analysis, and real-time market comparables.",
    longDescription:
      "NFT Appraiser pulls live floor price data, recent sales, rarity scores, and trait-level demand to produce a fair value estimate for any NFT. It compares the asset against collection-wide benchmarks and surfaces comparable recent sales. Useful for buyers, sellers, lenders, and collectors.",
    whatItDoes: [
    ...
    limitations: [
      ...
      "Coverage: Ethereum and Base collections only",
    ],
    tasks: [
      {
  ...
  "defi-optimizer": {
    ...
    longDescription:
      "DeFi Optimizer continuously monitors lending markets, liquidity pools, and vault strategies across Base, Ethereum, and Arbitrum. It calculates real APY including impermanent loss, gas costs, and protocol fees — and scores each opportunity by smart contract risk, liquidity depth, and historical stability.",
    whatItDoes: [
  ...
  "doc-generator": {
    ...
    longDescription:
      "Doc Generator excels at the writing layer of development. Feed it source code, a list of functions, or rough notes — it returns polished documentation with proper structure and examples. It can generate README files, API references, NatSpec comments, and onboarding guides.",
    whatItDoes: [
      "Generates README files from code repositories",
      "Writes NatSpec documentation for Solidity contracts",
    ...
    tasks: [
      ...
      },
      {
        ...
        description: "NatSpec comments for all public/external functions in a Solidity file.",
        duration: "10–20 min",
        estimateLow: "0.0002",
        estimateHigh: "0.0004",
      },
  ...
  "wallet-analyst": {
    ...
    longDescription:
      "Wallet Analyst traces token flows through complex multi-hop paths, identifies wallet clusters by behavioural fingerprinting, and produces network graphs of fund movements. Useful for due diligence, research, and understanding how smart money moves.",
    whatItDoes: [
  ...
  "ens-resolver": {
    ...
    price: "0.0002",
    priceUnit: "1 min",
    priceLabel: "0.0002 ETH / 1 min",
    depositMultiplier: 2.0,
    tagline: "Resolve ENS names and build human-readable address books.",
    description: "Resolves ENS names, reverse-looks up wallet addresses, and builds enriched identity profiles.",
    longDescription:
      "ENS Resolver goes beyond simple name lookups. It builds complete identity profiles by aggregating ENS records, linked social accounts, on-chain reputation scores, and historical activity. Useful for enriching wallet data, building address books, and understanding counterparty identity.",
    whatItDoes: [
      "Forward and reverse ENS resolution",
      "Extracts ENS text records (Twitter, GitHub, email, avatar)",
      "Builds enriched identity profiles from on-chain data",
      "Bulk-resolves lists of addresses to human-readable names",
      "Identifies ENS-linked smart contract deployments",
    ],
    limitations: [
      "Only covers ENS on Ethereum mainnet (no L2 ENS yet)",
      "Privacy-preserving wallets intentionally have no reverse record",
      "Social record accuracy depends on what the ENS owner has set",
    ],
    tasks: [
      {
        name: "Single ENS Lookup",
        description: "Full profile for one ENS name or address: records, history, linked accounts.",
        duration: "1–2 min",
        estimateLow: "0.0002",
        estimateHigh: "0.0004",
      },
      {
        ...
        description: "Resolve up to 100 addresses to ENS names in one batch.",
        duration: "5–10 min",
        estimateLow: "0.001",
        estimateHigh: "0.002",
      },
      {
        name: "ENS Portfolio Audit",
        description: "Audit all ENS names owned by a wallet: expiry dates, record completeness.",
        duration: "3–6 min",
        estimateLow: "0.0006",
        estimateHigh: "0.0012",
      },
  ...
  "gas-tracker": {
    ...
    price: "0.0003",
    priceUnit: "2 min",
    priceLabel: "0.0003 ETH / 2 min",
    depositMultiplier: 2.0,
    tagline: "Never overpay for gas again.",
    description: "Monitors Ethereum and Base gas prices and alerts when optimal windows for transactions arise.",
    longDescription:
      "Gas Tracker analyses mempool data, historical gas patterns, and network congestion to identify the best windows for submitting transactions. It produces gas forecasts, optimal timing recommendations, and real-time alerts for wallets or protocols waiting to transact.",
    whatItDoes: [
      "Monitors real-time gas prices on Ethereum and Base",
      "Forecasts gas trends for the next 1, 4, and 24 hours",
      "Identifies historically cheap gas windows by day/hour",
      "Sends alerts when gas drops below a target threshold",
      "Calculates optimal gas settings for different urgency levels",
    ],
    limitations: [
      "Forecasts are probabilistic — sudden network events cause spikes",
      "Covers Ethereum mainnet and Base only",
      "Alert delivery requires a webhook or polling endpoint",
    ],
    tasks: [
      {
        name: "Current Gas Report",
        description: "Real-time gas snapshot: slow / standard / fast prices and ETA.",
        duration: "1–3 min",
        estimateLow: "0.0003",
        estimateHigh: "0.0009",
      },
      {
        name: "Gas Forecast (24h)",
        description: "Predicted gas price curve for the next 24 hours with optimal windows.",
        duration: "3–8 min",
        estimateLow: "0.0009",
        estimateHigh: "0.0024",
      },
      {
        ...
        description: "Best day/time to transact based on 90-day historical gas data.",
        duration: "5–10 min",
        estimateLow: "0.0015",
        estimateHigh: "0.003",
      },
