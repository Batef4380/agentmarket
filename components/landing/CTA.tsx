...
export default function CTA() {
  ...
  return (
    <section id="contact" className="relative py-24 md:py-36 overflow-hidden" style={{ background: "#1A2E1A" }}>
      <div
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-12">
        <h2 className="font-anton leading-none text-cream" style={{ fontSize: "clamp(64px, 14vw, 200px)" }}>BUILD THE</h2>
        <h2 className="font-anton leading-none text-cream" style={{ fontSize: "clamp(64px, 14vw, 200px)" }}>FUTURE</h2>
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} className="flex items-center gap-0 max-w-xl">
            <input
              type="email"
              value={email}
